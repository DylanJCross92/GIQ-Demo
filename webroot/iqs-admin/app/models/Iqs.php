...
class Iqs 
{
    ...
    public function replaceZipWhiteListValues($arr) {
        return $this->Database->replaceZipWhiteListValues($arr);
    }
    ...
    public function bulkUpdateBlockCodesValues($arr) {
        return $this->Database->bulkUpdateBlockCodesValues($arr);
    }

    public function replaceBlockCodesValues($arr) {
        return $this->Database->replaceBlockCodesValues($arr);
    }
    ...
    public function deleteConfElementValue($confSection, $confElement) {
        return $this->Database->deleteConfElementValue($confSection, $confElement);
    }
