...
class FieldKeys {
    ...
    public static $IQS_CONF_ELEMENT_ENC_LEGACY_KEY = "legacykey";
    ...
    public static $ADDRESS_FULL_INFO_NUMBEROFFIREPLACESRETRIEVED = "NumberOfFireplacesRetrieved";
    public static $ADDRESS_FULL_INFO_NUMBEROFFULLBATHSRETRIEVED = "NumberOfFullBathsRetrieved";
    public static $ADDRESS_FULL_INFO_NUMBEROFHALFBATHSRETRIEVED = "NumberOfHalfBathsRetrieved";
    public static $ADDRESS_FULL_INFO_PROPERTY_COUNTY = "PropertyCounty";
