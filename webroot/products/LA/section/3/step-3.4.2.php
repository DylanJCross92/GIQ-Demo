...
<div class="content-wrapper">
    ...
    <form name="S3_4_FORM">
        ...
        <div class="body underwriting-block"><strong>We allow up to three additional features.</strong> Based on our experience, properties in your area usually have these features:</div>
        <ul class="home-features featured"></ul>
        <div class="body home-features-featured">Please select any additional home features if applicable totaling <strong>no more than three</strong>:</div>
            ...
            <li data-enum="800">
                ...
                <div class="features-dropdown-wrapper">
                    ...
                    <div class="toggle-box wood-deck-sqft S3_4_WoodDeck-parent" style="display:none;">
                        <select name="S3_4_WoodDeckSqFt" data-dropdown-menus="HomeFeatureSqFt"></select>
                    </div>
