...
export const SET_MASKED_SSN = 'SET_MASKED_SSN'
...
export const setMaskedSSN = (maskedSSN) => ({type: SET_MASKED_SSN, maskedSSN})
...
export default function sessionReducer(prevState = initialState, action) {
    ...
    switch (action.type) {
        ...
        case SET_MASKED_SSN:
            newState.maskedSSN = action.maskedSSN
            break;
...
export const dispatchMaskedSSN = (maskedSSN) => (dispatch) => {
    return dispatch(setMaskedSSN(maskedSSN))
}
