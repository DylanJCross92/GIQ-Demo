...
export const SET_LOAD_QUOTE = 'SET_LOAD_QUOTE'
export const SET_LOAD_FEATURES = 'SET_LOAD_FEATURES'
/* ----------   ACTION CREATORS     ------------------ */
...
export const setLoadQuote   = (isLoadingQuote) => ({type: SET_LOAD_QUOTE, isLoadingQuote})
export const setLoadFeatures = (isLoadingFeatures) => ({type: SET_LOAD_FEATURES, isLoadingFeatures})
...
export default function sessionReducer(prevState = initialState, action) {
    ...
    switch (action.type) {
        ...
        case SET_LOAD_FEATURES:
            newState.isLoadingFeatures = action.isLoadingFeatures
            break

        case SET_LOAD_QUOTE:
            newState.isLoadingQuote = action.isLoadingQuote
            break
...
export const dispatchLoadFeatures = (isLoadingFeatures) => (dispatch) => {
    return dispatch(setLoadFeatures(isLoadingFeatures))
}

export const dispatchLoadQuote = (isLoadingQuote) => (dispatch) => {
    return dispatch(setLoadQuote(isLoadingQuote))
}
