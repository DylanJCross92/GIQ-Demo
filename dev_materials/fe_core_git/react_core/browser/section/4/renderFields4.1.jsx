        ...
        <div>
            ...
            <div className="two-col">
                ...
                <div className="right">
                    ...
                    { fields.maskedSSN ?
                        <input name="S4_Insured1SSNDisplay" type="text" id="S4_Insured1SSN" value={fields.maskedSSN}
                               disabled={true}/> :
                        <input
                            className={fields[TermNames.Insured1SSN]['meta']['error'] && fields[TermNames.Insured1SSN]['meta']['touched'] ? 'error ' : ''} {...fields[TermNames.Insured1SSN].input}
                            type="text" id="S4_Insured1SSN" maxLength="11"/>
                    }
