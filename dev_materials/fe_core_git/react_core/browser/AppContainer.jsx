...
import { checkZipcode, setSessionId, setBeginQuote, setQuoteId, setZipcode } from './reducers/session.jsx'
    ...
    componentWillMount () {
        ...
        if (getSessionCookie(Product_State) && getQuoteIdCookie(Product_State)) {
            ...
            store.dispatch(getSessionStorage(getSessionCookie(Product_State)))
             store.dispatch(setQuoteId(getQuoteIdCookie(Product_State).split('-')[1]))
