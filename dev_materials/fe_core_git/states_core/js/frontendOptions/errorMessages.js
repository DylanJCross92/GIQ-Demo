var errors = {
				...
				VAL_2085_ERROR : {
									...
									errorMessageInvalid : "Please enter a Street Address.",
									errorCode : 2085,
				...
				VAL_2150_ERROR : {
									...
									errorCode : 2150,
									errorFormName : "S1_PropertyUsage"
				},
				...
				VAL_2175_ERROR : {
									...
									errorCode : 2175,
									errorFormName : "S1_TimeUnoccupied"
				},
				...
				VAL_3200_ERROR : {
					...
					errorMessageEmpty : "If your property has more than three features please call GEICO INSURANCE AGENCY at @phonenumber@.",
					errorMessageInvalid : "If your property has more than three features please call GEICO INSURANCE AGENCY at @phonenumber@.",
					errorCode : 3200,
				...
				VAL_PROPERTYSTATE_ERROR : {
					errorMessageEmpty: "Please enter an address in @curstate@",
					errorMessageInvalid: "Please enter an address in @curstate@",
					errorCode: 4000,
