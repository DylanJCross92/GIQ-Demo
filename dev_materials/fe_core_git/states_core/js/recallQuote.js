...
function recallQuoteSuccess(result)
{
	...
	if(result.exception!= null)
	{
		...
		if(errorCode == 10600)
		{
			recallQuoteError("We're sorry, however your quote cannot be found in our online system.  Please contact GEICO Insurance Agency at @phonenumber@ if you have questions or would like to purchase your quote.", "QuoteNumber");
		}
	...
	{	
		...
		updateRecallSessionStorageData(JSONdata);
