...
/***** This section added dynamically in the build_giq.xml PHING script (for dev) or via other template scripts ****/
 ...
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'ezquoteapi', N'baseurl', N'https://fnic-services.icg360.com/fnic-1/ezquote/api/ezquote/2/')
 ...
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'ezquoteapi', N'methodovrduid_ezaddresses', N'com.fednat.apps.ezquote')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'ezquoteapi', N'methodovrdpw_ezaddresses', N'2f3d8ff2899534c44d1c0192e2f6731f')
