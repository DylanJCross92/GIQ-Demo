/** iqsversion="1.8.17_dev_20170703_135056" **/
USE [master]
GO
...
/***** This section added dynamically in the build_giq.xml PHING script (for dev) or via other template scripts ****/
 ...
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'logging', N'databaselogging', N'true')
 ...
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'ezquoteapi', N'apiuid', N'e80000g')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'ezquoteapi', N'apipw', N'8681b8e18988a004b9b014a97e0a07f5')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'ezquoteapi', N'apialc', N'e80000g')
 ...
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'statesenabled', N'ak', N'true')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'statesenabled', N'al', N'true')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'statesenabled', N'la', N'true')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'statesenabled', N'nj', N'true')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'statesenabled', N'ny', N'true')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'statesenabled', N'sc', N'true')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'statesenabled', N'tx', N'true')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'statesenabled', N'va', N'true')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'productsenabled', N'akho3', N'true')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'productsenabled', N'alho3', N'true')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'productsenabled', N'laho3', N'true')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'productsenabled', N'njho3mp', N'true')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'productsenabled', N'nyho3', N'true')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'productsenabled', N'nydp3', N'true')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'productsenabled', N'scho3', N'true')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'productsenabled', N'scdp3', N'true')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'productsenabled', N'txho3', N'true')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'productsenabled', N'vaho3', N'true')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'whitelistenabled', N'akho3', N'false')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'whitelistenabled', N'alho3', N'false')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'whitelistenabled', N'laho3', N'false')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'whitelistenabled', N'njho3mp', N'false')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'whitelistenabled', N'nyho3', N'false')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'whitelistenabled', N'nydp3', N'false')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'whitelistenabled', N'scho3', N'false')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'whitelistenabled', N'scdp3', N'false')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'whitelistenabled', N'txho3', N'false')
 INSERT [dbo].[Conf] ([ConfSection], [ConfElement], [ConfValue]) VALUES (N'whitelistenabled', N'vaho3', N'false')
 ...
 INSERT [dbo].[BlockCodes] ([BlockCode], [BlockText], [DateTime]) VALUES (N'410', N'coverage A too low fl', CURRENT_TIMESTAMP)
