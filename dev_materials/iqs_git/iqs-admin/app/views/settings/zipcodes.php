        ...
        <div class="table-actions">
            <div class="multi-cols">
                ...
                <div class="col-2">
                    ...
                    <a href="#" class="button green replace-csv-zip-whitelist tooltip-parent">Import New
                        <div class="tooltip">
                            Import New Zipcode Whitelist
                            </p>
                            <div>- Entire Whitelist file will be replaced</div>
                            <div>- CSV must have column headers "state,product,zipcode"</div>
                        </div>
                    </a>
                    <a href="#" class="button green import-csv-zip-whitelist tooltip-parent">Update
                        <div class="tooltip">
                            Update Zipcode Whitelist
                            </p>
                            <div>- Merge new Whitelist file with old Whitelist </div>
                            <div>-CSV must have column headers "state,product,zipcode"</div>
                        </div>
                    </a>
                    <a href="csv.php?template=zipcodes" target="_blank" class="button gray export-csv-zip-whitelist tooltip-parent">Export
                        <div class="tooltip">
                            Export Zipcode Whitelist
                            </p>
                            <div>- Download Whitelist in csv format</div>
                        </div>
                    </a>
                </div>
            </div>
...
<form style="display: none;" action="" method="post" enctype="multipart/form-data" name="replace_zip_whitelist_csv" id="form1">
    Choose your file: <br />
    <input name="csv" type="file" id="csv" />
    <input type="submit" name="Submit" value="Submit" />
</form>
