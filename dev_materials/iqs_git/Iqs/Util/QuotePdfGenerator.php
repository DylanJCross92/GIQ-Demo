    ...
    class QuotePdfGenerator {
        ...
        public function generateQuotePdf($quoteFields, $quoteId){
			...
			*/
            ...
            if(array_key_exists('AdditionalAmountsOfInsurance', $quoteFields)) {
            ...
            if(array_key_exists('IncreasedOrdinanceLimit', $quoteFields)) {
            ...
            if(array_key_exists('AllOtherPerilsDeductible', $quoteFields)) {
			...
			if(array_key_exists('PersonalPropertyReplacementCost', $quoteFields))
			{
				...
				{
					$PersonalPropertyReplacementCost = "Replacement Cost";
				}
