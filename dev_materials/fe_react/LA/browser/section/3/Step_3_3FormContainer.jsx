...
import Step_3_3 from './Step-3.3.jsx'
import {dispatchSetPageId } from '../../reducers/session.jsx'

export class Step_3_3FormContainer extends Component {
    componentDidMount (){

        let pageId = '3.3'
        this.props.dispatchSetPageId('3.3')
        this.props.change('FORM', 'LastQuoteSectionPageId', '3.3')
...
export default connect(mapState, mapDispatch)(Step_3_3FormContainer)