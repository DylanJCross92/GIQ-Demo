...
import Step_3_1 from './Step-3.2.jsx'
import {dispatchSetPageId } from '../../reducers/session.jsx'

export class Step_3_2FormContainer extends Component {
    componentDidMount (){

        let pageId = '3.2'
        this.props.dispatchSetPageId('3.2')
        this.props.change('FORM', 'LastQuoteSectionPageId', '3.2')
...
export default connect(mapState, mapDispatch)(Step_3_2FormContainer)