import { createValidator, required, maxLength, minLength, text, alphaNumeric, address, currentState, numeric, checkField, date, futureDate, currency, claimNumber } from './validationRules.js'
...
const step2Validation = createValidator({
    ...
    [TermNames.LossAmount1]: [claimNumber(1), currency],
    ...
    [TermNames.LossAmount2]: [claimNumber(2), currency],
    ...
    [TermNames.LossAmount3]: [claimNumber(3), currency],
