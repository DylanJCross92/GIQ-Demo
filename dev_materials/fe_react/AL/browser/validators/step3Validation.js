import { createValidator, required, maxLength, checkField, checkFeature, checkNotField, yearRoof, minLength, text, alphaNumeric, address, currentState, numeric, futureDate, squareFoot, notAfter } from './validationRules.js'
