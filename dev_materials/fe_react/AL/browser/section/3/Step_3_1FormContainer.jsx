...
import Step_3_1 from './Step-3.1.jsx'
import {dispatchSetPageId } from '../../reducers/session.jsx'

export class Step_3_1FormContainer extends Component {
    componentDidMount (){

        let pageId = '3.1'
        this.props.dispatchSetPageId('3.1')
        this.props.change('FORM', 'LastQuoteSectionPageId', '3.1')
...
export default connect(mapState, mapDispatch)(Step_3_1FormContainer)